...
pub use common::{
    Subscriber, Transaction, AdditionalInfo, ApiStatus,
    EnhancedSubscriber, TransactionData
};
...
impl AirtelMoney {
    ...
    pub fn collection(&self, client_id: String, client_secret: String) -> Collection {
        Collection::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
    ...
    pub fn disbursement(&self, client_id: String, client_secret: String) -> Disbursement {
        Disbursement::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
    ...
    pub fn remittance(&self, client_id: String, client_secret: String) -> Remittance {
        Remittance::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
    ...
    pub fn cash_in(&self, client_id: String, client_secret: String) -> CashIn {
        CashIn::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
    ...
    pub fn cash_out(&self, client_id: String, client_secret: String) -> CashOut {
        CashOut::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
    ...
    pub fn account(&self, client_id: String, client_secret: String) -> Account {
        Account::new(self.country, self.currency, self.environment, client_id, client_secret)
    }
}